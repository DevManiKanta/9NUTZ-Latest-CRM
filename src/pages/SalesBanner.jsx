...
//         <h1 className="text-xl font-semibold">Sales Banners</h1>
...
//                   <td className="px-4 py-3">{b.link ? <a href={b.link} target="_blank" rel="noreferrer" className="text-blue-600 underline">{b.link}</a> : "—"}</td>
